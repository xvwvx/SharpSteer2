...
namespace SharpSteer2.Tests
{
    ...
    public class MeshPathwayTest
    {
        ...
        {
            new TrianglePathway.Triangle(new Vector3(0, 0, 0), new Vector3(0, 0, 1), new Vector3(1, 0, 0)),
            new TrianglePathway.Triangle(new Vector3(0, 0, 1), new Vector3(1, 0, 1), new Vector3(1, 0, 0)),
            new TrianglePathway.Triangle(new Vector3(1, 0, 1), new Vector3(2, 0, 1), new Vector3(1, 0, 0)),
        });
